  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xcd, 0x6a, 0xc9, 0x13, 0x93, 0x6d, 0xbf, 0x38,
      0xfe, 0xd6, 0x2e, 0xce, 0xdc, 0x1d, 0x7a, 0xf6,
      0x74, 0x29, 0x3d, 0x09, 0x0f, 0xeb, 0x14, 0xb8,
      0x28, 0xe0, 0xf8, 0xda, 0x61, 0x93, 0xdc, 0x35,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t prak_msgs__msg__JointStateStamped__EXPECTED_HASH = {1, {
...
static char prak_msgs__msg__RobotState__TYPE_NAME[] = "prak_msgs/msg/RobotState";
...
static char prak_msgs__msg__RobotState__FIELD_NAME__header[] = "header";
static char prak_msgs__msg__RobotState__FIELD_NAME__joint_state[] = "joint_state";
static char prak_msgs__msg__RobotState__FIELD_NAME__tcp_pose[] = "tcp_pose";

static rosidl_runtime_c__type_description__Field prak_msgs__msg__RobotState__FIELDS[] = {
  {
    {prak_msgs__msg__RobotState__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {prak_msgs__msg__RobotState__FIELD_NAME__joint_state, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {prak_msgs__msg__RobotState__FIELD_NAME__tcp_pose, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription prak_msgs__msg__RobotState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {prak_msgs__msg__RobotState__TYPE_NAME, 24, 24},
      {prak_msgs__msg__RobotState__FIELDS, 3, 3},
    },
    {prak_msgs__msg__RobotState__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&prak_msgs__msg__JointStateStamped__EXPECTED_HASH, prak_msgs__msg__JointStateStamped__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[6].fields = prak_msgs__msg__JointStateStamped__get_type_description(NULL)->type_description.fields;
...
static char toplevel_type_raw_source[] =
  ...
  "\n"
  "\n"
  "prak_msgs/JointStateStamped joint_state\n"
  "\n"
...
prak_msgs__msg__RobotState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *prak_msgs__msg__RobotState__get_individual_type_description_source(NULL),
    ...
    sources[7] = *prak_msgs__msg__JointStateStamped__get_individual_type_description_source(NULL);
