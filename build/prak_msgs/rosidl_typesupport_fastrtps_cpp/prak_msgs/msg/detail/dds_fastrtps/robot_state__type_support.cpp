...
#include "prak_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const prak_msgs::msg::JointStateStamped &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  prak_msgs::msg::JointStateStamped &);
size_t get_serialized_size(
  const prak_msgs::msg::JointStateStamped &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const prak_msgs::msg::RobotState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  prak_msgs::msg::RobotState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: joint_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        prak_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_JointStateStamped(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = prak_msgs::msg::RobotState;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: joint_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        prak_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_JointStateStamped(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const prak_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<prak_msgs::msg::RobotState *>(
    untyped_ros_message);
...
get_message_type_support_handle<prak_msgs::msg::RobotState>()
{
  return &prak_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prak_msgs, msg, RobotState)() {
  return &prak_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
